      ...
      <View style={styles.productInfoWithStatusPrice}>
        <View style={styles.productImageAndInfoContainer}>
          ...
          <View style={styles.productInfo}>
            ...
            <Text style={styles.productId} numberOfLines={1} ellipsizeMode="tail">
              ID: {item.productId}
            </Text>
            <View style={styles.platformContainer}>
              <View style={styles.platformTextContainer}>
                <Text style={styles.platformText}>{item.platform}</Text>
                <Text style={styles.platformText}>• {item.date}</Text>
              </View>
              <View style={styles.timeContainer}>
                <Clock size={14} weight="regular" color={colors.text.muted} />
  ...
  const enrollments: Enrollment[] = [
    {
      ...
      timeAgo: '2h ago',
      status: 'Approved',
      productImage: 'https://m.media-amazon.com/images/I/71xpRUvEuxL._AC_UF350,350_QL80_.jpg',
    ...
    },
    {
      ...
      status: 'Pending',
      productImage:
        'https://spigen.in/cdn/shop/files/title_web_ipadpro11_2023__ultrahybridpro_01_1200x1200.jpg?v=1746866161',
      enrolledBy: {
        name: 'Alex Chen',
    ...
    },
    {
      ...
      timeAgo: '2w ago',
      status: 'Approved',
      productImage: 'https://m.media-amazon.com/images/I/61WLCXa6kxL.jpg',
      enrolledBy: {
        name: 'Jessica Miller',
