...
export function useInvalidateQueries() {
	...
	return {
		...
		invalidateCampaigns: (orgId: string) =>
			queryClient.invalidateQueries({ queryKey: queryKeys.campaigns(orgId) }),
		invalidateListings: (orgId: string) =>
			queryClient.invalidateQueries({ queryKey: queryKeys.listings(orgId) }),
		invalidateEnrollments: (orgId: string) =>
			queryClient.invalidateQueries({ queryKey: queryKeys.enrollments(orgId) }),
		invalidateWallet: (orgId: string) =>
			queryClient.invalidateQueries({ queryKey: queryKeys.wallet(orgId) }),
